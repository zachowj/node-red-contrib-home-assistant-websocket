...
interface SensorEditorNodeProperties extends HassNodeProperties {
    entityConfig: any;
    state: string;
...
const SensorEditor: EditorNodeDef<SensorEditorNodeProperties> = {
    ...
    defaults: {
        ...
        entityConfig: {
            ...
            filter: (config) => config.entityType === 'sensor',
            required: true,
        },
