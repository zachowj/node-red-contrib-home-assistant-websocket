...
export const TYPEDINPUT_DATE = 'date';
export const TYPEDINPUT_BOOL = 'bool';
export const TYPEDINPUT_ENV = 'env';
export const TYPEDINPUT_JSON = 'json';
export const TYPEDINPUT_JSONATA = 'jsonata';
export const TYPEDINPUT_NONE = 'none';
export const TYPEDINPUT_NUM = 'num';
export const TYPEDINPUT_STR = 'str';
