        ...
        describe('comparator types', function () {
            ...
            describe('Home Assistant State Boolean', function () {
                describe('is in (includes)', function () {
                    ...
                    it('should return true for all lowercase habool truthy values', async function () {
                        const truthyValues = [
                            'y',
                            'yes',
                            'true',
                    ...
                    it('should return true for all uppercase habool truthy values', async function () {
                        const truthyValues = [
                            'Y',
                            'YES',
                            'TRUE',
